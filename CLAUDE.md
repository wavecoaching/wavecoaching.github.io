...
A marketing/coaching site for Wave Coaching, built with Astro and Tailwind CSS.
...
- Do not add a `base` path in Astro config — this is a root pages site, not a subdirectory deployment
